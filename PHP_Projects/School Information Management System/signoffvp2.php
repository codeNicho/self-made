               ...
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                       <!--
                       <a href="addteachactiv.php">Add Teacher Activity</a>&nbsp;&nbsp;
                       <a href="viewactiv.php">View Teacher Activity</a>&nbsp;&nbsp;
                       <a href="viewreportprincipal.php">View A Student Report</a>&nbsp;&nbsp;
                       <a href="signoffvp.php">Sign Off Vice-Principal</a>
                       <br><br>
                       <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                          <div class="menu-area">
                             <div class="limit-box">
                     ...
                     -->
                        ...
                        <h2 style="text-align:center;color:white;" >Vice Principal's Profile Information</h2>

                        <div class="card">
                          <h3 style="text-align:left;"><?php  if (isset($_SESSION['id'])) :
                          echo "Teacher ".$_SESSION['vtfname_111t']." ".$_SESSION['vtlname_111t']." with ID: ".$_SESSION['vtidnum_111t']." Has activities to be signed off.";
                            endif ?>
                          </h3>
                        ...
                        <br><br>
                        <a href="signoffsuccess.php">Click To Sign Off Teacher's Activities</a>
