                           ...
                           <ul class="menu-area-main">
                             <li> <a href="adminpage.php">Home</a>
                              ...
                              <li><a href="#"><?php  if (isset($_SESSION['id'])) :
                              	echo "Welcome System Administrtor";
                                endif ?></a></li>
                           </ul>
                        </nav>
                     </div>
               ...
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                       <button style='background:blue;border: 2px solid #5F9EA0;
                       border-radius: 12px;' onclick="myFunction()">Click To Optimize System</button>
                      <p id="demo"></p>
                      <script>
                        function myFunction() {
                          document.getElementById("demo").innerHTML = "System Performance: 100% Capacity <br> Data Cache: cleared <br> Performance: 100% Capacity <br> Server CPU: 90% <br> Memory Freed: 72% <br> Disk : 40% <br> Network: 34% <br> System now Operating With Optimal Performance!";
                        }
                      </script>
                       <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                          <div class="menu-area">
