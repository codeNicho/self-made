               ...
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                       <a href="uploadreport.php">Upload Student Report</a>
                       <a href="updatereport.php">Update Student Report</a>
                       <a href="viewreport.php"  >View Students Reports!</a><br><br>
                       <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                          <div class="menu-area">
                             <div class="limit-box">
                                <nav class="main-menu">
                        ...
                        <h2 style="text-align:center;color:white;" >Teacher Profile Information</h2>
