                     ...
                     <div class="carousel-caption relative">
                       <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                        ...
                        <table style="text-align:left;color:white;" id="customers">
                          ...
                          <tr>
                        		<td>Student ID<br></td>
                            <td><?php echo $_SESSION['idnum_1111'];?></td>
                      	<tr>
                      		<td>Type of Report Card<br></td>
                          <td><?php echo $_SESSION['type_1111'];?></td>
                      	</tr>
                      	<tr>
                      		<td width="100px";>Name of Student</td>
                          <td width="100px";><?php echo $_SESSION['fname_1111']." ".$_SESSION['lname_1111'];?></td>
                      	</tr>
                      	<tr>
                      		<td>Date of Report</td>
                      		<td><?php echo $_SESSION['repdate_1111'];?></td>
                      	</tr>
                      	<tr>
                      		<td>Status of Student</td>
                      		<td><?php echo $_SESSION['status_1111'];?></td>
                      	</tr>
                      	</tbody>
                      </table><br>
                      ...
                      <table id="customers">
                    	...
                    	<tbody>
                    	<tr>
                    		<td><?php echo $_SESSION['subject_1111'];?><br></td>
                    		<td><?php echo $_SESSION['attendance_1111'];?><br></td>
                    		<td><?php echo $_SESSION['period_1111'];?></td>
                    		<td><?php echo $_SESSION['score_1111']?></td>
                    		<td><?php echo $_SESSION['performance_1111']?></td>
                    	</tr>
                    	<tbody>
                    </table>
