               ...
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                       <a href="createtimetable.php">Create Class Timetable</a>&nbsp;&nbsp;
                       <a href="assignteacher.php">Assign Teacher to Class</a>&nbsp;&nbsp;
                       <a href="viewallassigned.php">View All Teachers Assigned</a>&nbsp;&nbsp;
                       <a href="assessteacher.php">Assess A Class Teacher</a><br><br>
                       <a style='top:15px;' href="viewassessment.php">View Teacher Assessment</a>
                       <br><br>
                       <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                          <div class="menu-area">
                             <div class="limit-box">
