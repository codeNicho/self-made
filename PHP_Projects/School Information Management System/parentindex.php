                        ...
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              ...
                              <li><a href="#"><?php  if (isset($_SESSION['id'])) :
                              	echo "Welcome ".$_SESSION['pfname']." ".$_SESSION['plname'];
                                endif ?></a></li>
                           </ul>
                        </nav>
                     </div>
               ...
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                       <a href="studentreportparents.php">View Your Child's Report</a><br><br>
                       <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                          <div class="menu-area">
                             <div class="limit-box">
                                <nav class="main-menu">
                        ...
                        <h2 style="text-align:center;color:white;" >Parent Profile Information</h2>
                        ...
                        <div class="card">
                          <h3 style="text-align:left;"><?php  if (isset($_SESSION['id'])) :
                            ...
                            echo "Password: ".$_SESSION['ppassword']."<br>";
                            endif ?>
                          </h3>
