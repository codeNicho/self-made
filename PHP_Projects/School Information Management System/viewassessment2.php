                     ...
                     <div class="carousel-caption relative">
                       <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                        ...
                        <table style="text-align:left;color:white;" id="customers">
                      	<thead>
                      	<tr>
                      		<th colspan="2"><h2 style="text-align:center;color:white;" >Teacher Assessment Report</h2><br></th>
                      	</tr>
                      	</thead>
                      	<tbody>
                          <tr>
                        		<td>Teacher ID<br></td>
                            <td><?php echo $_SESSION['assessidnum_111'];?></td>
                      	<tr>
                      		<td width="100px";>Name of Teacher</td>
                          <td width="100px";><?php echo $_SESSION['assessfname_111']." ".$_SESSION['assesslname_111'];?></td>
                      	</tr>
                      	<tr>
                      		<td>Date of Assessment</td>
                      		<td><?php echo $_SESSION['assessrepdate_111'];?></td>
                      	</tr>
                      	<tr>
                      		<td>Assessment Type</td>
                      		<td><?php echo $_SESSION['assesstype_111'];?></td>
                      	</tr>
                      	</tbody>
                      </table><br>
                      ...
                      <table id="customers">
                    	...
                    	<tbody>
                    	<tr>
                    		<td><?php echo $_SESSION['assesssemester_111'];?><br></td>
                    		<td><?php echo $_SESSION['assessduration_111'];?><br></td>
                    		<td><?php echo $_SESSION['assessperiod_111'];?></td>
                    		<td><?php echo $_SESSION['assessperformance_111']?></td>
                        <td><?php echo $_SESSION['assesssperiod1_111']?></td>
                        <td><?php echo $_SESSION['assessfinal_111']?></td>
                    	</tr>
                    	<tbody>
                    </table>
