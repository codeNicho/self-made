                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              <li> <a href="parentindex.php">Home</a> </li>
               ...
               <div class="carousel-item active">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                       ...
                       <?php if(empty($_SESSION['fname_11116'])){
                         echo"<p style='text-align:left;color:white;' id='customers'> A teacher need to populate your child's report card first<p>";
                       }
                       ?>
                        <table style="text-align:left;color:white;" id="customers">
                      	<thead>
                      	<tr>
                      		<th colspan="2"><h2 style="text-align:center;color:white;" >Your Child's Report Card</h2><br></th>
                      	</tr>
                      	</thead>
                      	<tbody>
                          <tr>
                        		<td>Student ID<br></td>
                            <td><?php echo $_SESSION['idnum_11116'];?></td>
                      	<tr>
                      		<td>Type of Report Card<br></td>
                          <td><?php echo $_SESSION['type_11116'];?></td>
                      	</tr>
                      	<tr>
                      		<td width="100px";>Name of Student</td>
                          <td width="100px";><?php echo $_SESSION['fname_11116']." ".$_SESSION['lname_11116'];?></td>
                      	</tr>
                      	<tr>
                      		<td>Date of Report</td>
                      		<td><?php echo $_SESSION['repdate_11116'];?></td>
                      	</tr>
                      	<tr>
                      		<td>Status of Student</td>
                      		<td><?php echo $_SESSION['status_11116'];?></td>
                      	</tr>
                      	</tbody>
                      </table><br>
                      ...
                      <table id="customers">
                    	...
                    	<tbody>
                    	<tr>
                    		<td><?php echo $_SESSION['subject_11116'];?><br></td>
                    		<td><?php echo $_SESSION['attendance_11116'];?><br></td>
                    		<td><?php echo $_SESSION['period_11116'];?></td>
                    		<td><?php echo $_SESSION['score_11116']?></td>
                    		<td><?php echo $_SESSION['performance_11116']?></td>
                    	</tr>
                    	<tbody>
                    </table>
