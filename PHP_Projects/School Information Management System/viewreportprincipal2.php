                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              <li> <a href="principalindex.php">Home</a> </li>
                     ...
                     <div class="carousel-caption relative">
                       <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                        ...
                        <table style="text-align:left;color:white;" id="customers">
                      	<thead>
                      	<tr>
                      		<th colspan="2"><h2 style="text-align:center;color:white;" >Student Report Card</h2><br></th>
                      	</tr>
                      	</thead>
                      	<tbody>
                          <tr>
                        		<td>Student ID<br></td>
                            <td><?php echo $_SESSION['tidnum_111t'];?></td>
                      	<tr>
                      		<td>Type of Report Card<br></td>
                          <td><?php echo $_SESSION['ttype_111t'];?></td>
                      	</tr>
                      	<tr>
                      		<td width="100px";>Name of Student</td>
                          <td width="100px";><?php echo $_SESSION['tfname_111t']." ".$_SESSION['tlname_111t'];?></td>
                      	</tr>
                      	<tr>
                      		<td>Date of Report</td>
                      		<td><?php echo $_SESSION['trepdate_111t'];?></td>
                      	</tr>
                      	<tr>
                      		<td>Status of Student</td>
                      		<td><?php echo $_SESSION['tstatus_111t'];?></td>
                      	</tr>
                      	</tbody>
                      </table><br>
                      ...
                      <table id="customers">
                    	...
                    	<tbody>
                    	<tr>
                    		<td><?php echo $_SESSION['tsubject_111t'];?><br></td>
                    		<td><?php echo $_SESSION['tattendance_111t'];?><br></td>
                    		<td><?php echo $_SESSION['tperiod_111t'];?></td>
                    		<td><?php echo $_SESSION['tscore_111t']?></td>
                    		<td><?php echo $_SESSION['tperformance_111t']?></td>
                    	</tr>
                    	<tbody>
                    </table>
