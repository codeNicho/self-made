...
<body>
  ...
  <form method="post" action="updatereport2.php">
  	<?php include('errors.php'); ?>
  	<div class="input-group">
  	  <label>Enter Date of report</label>
  	  <input type="date" name="repdate2" required>
  	</div>
    <div class="input-group">
      <select id="status" name="status2" required>
    ...
    <div class="input-group">
      <select id="attendance" name="attendance2" required>
      ...
      <input type="radio" id="one" name="period2" value="1st" checked>
      <label for="one">1<sup>st<sup></label><br>

      <input type="radio" id="two" name="period2" value="2nd">
      <label for="two">2<sup>nd<sup></label><br>


      <input type="radio" id="three" name="period2" value="3rd">
      <label for="three">3<sup>rd<sup></label><br>

      <input type="radio" id="four" name="period2" value="4th">
      <label for="four">4<sup>th<sup></label><br><br>

      <label for="score">Score(0-100)</label><br>
      <input type="number" id="score" name="score2" min="0" max="100" required>

      <div class="input-group">
        <select id="performance" name="performance2" required>
  	...
  	<div class="input-group">
  	  <button type="submit" class="btn" name="uploadreport2">Update Report</button>
  	</div>
    <div class="input-group">
