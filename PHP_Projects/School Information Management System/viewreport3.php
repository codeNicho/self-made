                     ...
                     <div class="carousel-caption relative">
                       <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                        ...
                        <table style="text-align:left;color:white;" id="customers">
                      	<thead>
                      	<tr>
                      		<th colspan="2"><h2 style="text-align:center;color:white;" >Teacher Activity Report</h2><br></th>
                      	</tr>
                      	</thead>
                      	<tbody>
                          <tr>
                        		<td>Teacher ID<br></td>
                            <td><?php echo $_SESSION['tidnum_111'];?></td>
                      	<tr>
                      		<td width="100px";>Name of Teacher</td>
                          <td width="100px";><?php echo $_SESSION['tfname_111']." ".$_SESSION['tlname_111'];?></td>
                      	</tr>
                      	<tr>
                      		<td>Date of Activity</td>
                      		<td><?php echo $_SESSION['trepdate_111'];?></td>
                      	</tr>
                      	<tr>
                      		<td>Activity Type</td>
                      		<td><?php echo $_SESSION['ttype_111'];?></td>
                      	</tr>
                      	</tbody>
                      </table><br>
                      ...
                      <table id="customers">
                    	...
                    	<tr>
                    		...
                    		<th>Duration<br></th>
                    		<th>Period</th>
                    		<th>Number of Persons Involved</th>
                        <th>Performance</th>
                    	</tr>
                    	</thead>
                    	<tbody>
                    	<tr>
                    		<td><?php echo $_SESSION['tsemester'];?><br></td>
                    		<td><?php echo $_SESSION['tduration'];?><br></td>
                    		<td><?php echo $_SESSION['tperiod'];?></td>
                    		<td><?php echo $_SESSION['tinvolved'];?></td>
                        <td><?php echo $_SESSION['tperformance3'];?></td>
                    	</tr>
                    	<tbody>
                    </table>
